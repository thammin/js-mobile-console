...
[].slice.call(arguments);e.oldinfo.apply(window.console,t)},window.console.warn=function(){var t=[].slice.call(arguments);e.oldwarn.apply(window.console,t)},window.console.error=function(){var t=[].slice.call(arguments);e.olderror.apply(window.console,t)})},logValue:function(e,n,r){var i=document.createElement("div");i.className="jsmc-log-el",i.innerHTML=t,n&&(i.className+=" jsmc-log-error"),r&&(i.className+=" jsmc-log-command");var s=i.getElementsByClassName("jsmc-log-text")[0],o=e.match(/(\%c).*(rgba\(.*\))/),u=e.match(/.*(\[WATCHER\]\:).*(\[Digest\]\:).*rgba\(.*\).*\s(\d+)\s(\d+\.*\d+)/);s.innerHTML=o?u?u[1]+u[3]+u[2]+u[4]:"\u2193-----":e,s.style.background=o?o[2]:"";if(typeof n=="string"){var a=i.getElementsByClassName("jsmc-log-target")[0];a.innerHTML=n}this.appendLogEl(i)}};return n});
